...
the general methods in this module.
# Examples
```julia-repl
...
The  next example  uses `Group(AbstractVector{<:Perm})`  which constructs a
`PermGroup` which has more efficient methods.
...
[`order`](@ref),
[`conjugacy_class`](@ref), 
[`conjugacy_classes`](@ref),
[`classreps`](@ref), 
[`number_of_conjugacy_classes`](@ref),
[`fusion_conjugacy_classes`](@ref),               
[`position_class`](@ref),
[`isabelian`](@ref), 
[`iscyclic`](@ref), 
[`istrivial`](@ref), 
[`rand`](@ref),
[`transporting_element`](@ref),     
[`intersect`](@ref),    
[`Hom`](@ref),
[`kernel`](@ref), 
[`Coset`](@ref),
